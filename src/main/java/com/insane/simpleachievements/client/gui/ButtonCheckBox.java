...
public class ButtonCheckBox extends GuiButton
{
	...
	public void drawButton(Minecraft par1Minecraft, int mouseX, int mouseY)
	{
        ...
        ArrayList<String> lines = getExpectedLines(achievement.text);
        switch (lines.size()) {
            case 1:
                par1Minecraft.fontRenderer.drawString(this.displayString, xPosition + 25, yPosition + (height / 2) - 4, achievement.getState() ? 0x009105 : 0x000000, false);
                break;
            case 2:
                par1Minecraft.fontRenderer.drawString(lines.get(0), xPosition + 25, yPosition + (height / 3) - 4, achievement.getState() ? 0x009105 : 0x000000, false);
                par1Minecraft.fontRenderer.drawString(lines.get(1), xPosition + 25, yPosition + 2*(height / 3) - 4, achievement.getState() ? 0x009105 : 0x000000, false);
                break;
            case 3:
                par1Minecraft.fontRenderer.drawString(lines.get(0), xPosition + 25, yPosition + (height / 3) - 6, achievement.getState() ? 0x009105 : 0x000000, false);
                par1Minecraft.fontRenderer.drawString(lines.get(1), xPosition + 25, yPosition + 2*(height / 3) - 6, achievement.getState() ? 0x009105 : 0x000000, false);
                par1Minecraft.fontRenderer.drawString(lines.get(2), xPosition + 25, yPosition + 3*(height / 3) - 6, achievement.getState() ? 0x009105 : 0x000000, false);
                break;
            default:
