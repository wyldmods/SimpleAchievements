...
public class RenderAchievementBook extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntityEnchantmentTableAt(TileEntityAchievementStand tile, double par2, double par4, double par6, float par8)
	{
		if (tile.getBlockMetadata() == 0)
		{
			...
			for (f2 = tile.bookRotation2 - tile.bookRotationPrev; f2 >= (float) Math.PI; f2 -= ((float) Math.PI * 2F))
			{
				;
			}
			...
			float f3 = tile.bookRotationPrev + f2 * par8;
			...
			float f6 = tile.bookSpreadPrev + (tile.bookSpread - tile.bookSpreadPrev) * par8;
